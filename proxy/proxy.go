...
func (s *ProxyServer) Start() {
	...
	r := mux.NewRouter()
	r.Handle("/{login:Zx[0-9a-zA-Z]{95,}$|login:iZ[0-9a-zA-Z]{95,}$|login:aZx[0-9a-zA-Z]{95,}$|login:aiZX[0-9a-zA-Z]{95,}$}/{id:[0-9a-zA-Z-_]{1,8}}", s)
	r.Handle("/{login:Zx[0-9a-zA-Z]{95,}$|login:iZ[0-9a-zA-Z]{95,}$|login:aZx[0-9a-zA-Z]{95,}$|login:aiZX[0-9a-zA-Z]{95,}$}", s)
	srv := &http.Server{
